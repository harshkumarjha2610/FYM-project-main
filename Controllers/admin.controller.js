  ...
  try {
    ...
    if (coordinates && 
      ...
      sellerData.location = {
        type: "Point",
        coordinates: [
          coordinates.longitude,   // ⚠️ longitude FIRST
          coordinates.latitude     // ⚠️ latitude SECOND
        ],
        address: location ? location.trim() : undefined
      };

      console.log("✅ Location saved in GeoJSON format:", sellerData.location);
    }
